    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div class="container-fluid">
            ...
            <div class="search-wrapper d-flex">
                <input type="search" list="result" name="keyword" id="keyword" placeholder="   Search city..."
                    autocomplete="off" class="form-control me-2 search-form" onchange="selectRow(value);"
                    data-search-field>
...
<?php
    ...
    // get navbar-dark and change it to navbar-light
    echo "<script>
    ...
    <div class="container-fluid" style="background-color: transparent; padding: 5px; height:80vh;">
        <div class="row" style="background-color: transparent;">
            <div class="col-xl-3 col-12 card left-content">
                <div class="card-body current-weather shadow-add" style="border-bottom: 0;">
                    ...
                    <div class="card-title">
                        <div class="row">
                            <div class="col-sm-6 col-6" style="font-size: 3.5rem;" data-current-temperature>
                            ...
                            <div class="col-sm-6 col-6">
                                <img src="./assets/images/weather_icons/animated/<?php echo $weather->currentWeatherData['icon'] ?>"
                ...
                <div class="card-body daily-forecast shadow-add" style="border-top: 0;" data-daily-forecast>
                    <div class="card-body">
                        ...
                        <ul>
                            ...
                            for ($i = 0; $i < 7; $i++) {
                                echo '
                                <li class="daily-forecast-item borderless">
            ...
            <div class="col-xl-9 col-12 card right-content slider-container overflow-auto"
                ...
                <div class="col card shadow-add" style="background-color:transparent;">
                    ...
                    <div class="row section hourly-forecast" style="background-color: transparent;">
                        ...
                        <div class="slider-container" style="padding: 3rem;">
                            <ul class="slider-container row d-flex flex-row flex-nowrap overflow-auto slider-list"
                                data-temp>
                                <?php
                                for ($i = 0; $i < 24; $i++) {
                                    echo '
